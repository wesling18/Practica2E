...
const ChatIA = ({ mostrar, onCerrar }) => {
  ...
  - empleados (id_empleado, nombre, apellido, email, celular, tipo_empleado)
  `;
  ...
  const enviarConsulta = async () => {
    ...
    try {
      ...
      // Extraemos el objeto JSON directamente de la respuesta (evitando problemas de bloques de código markdown)
